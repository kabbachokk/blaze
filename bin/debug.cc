...
#define get_num_va_args(_args, _lcount) \
    (((_lcount) > 1) ? va_arg(_args, long long int) : (((_lcount) == 1) ? va_arg(_args, long int) : va_arg(_args, int)))

#define get_unum_va_args(_args, _lcount) \
    (((_lcount) > 1) ? va_arg(_args, unsigned long long int) : (((_lcount) == 1) ? va_arg(_args, unsigned long int) : va_arg(_args, unsigned int)))
